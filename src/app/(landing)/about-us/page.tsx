...
const AboutUs = () => {
  ...
  return (
    <div className="l-container flex flex-col justify-center items-center gap-5 bg-BgLight/30 rounded-ss-full">
      ...
      <p data-aos="fade-up" className="text-justify italic leading-loose w-3/4">
        ...
        <span>
          ...
          facilities, which blend modern aesthetics with functionality, creating
          an environment that motivates and inspires. At GymMax, we are
          dedicated to fostering not only physical health but also overall
          well-being. Our state-of-the-art equipment ensures that every workout
          is efficient and effective, whether you are aiming to build strength,
          improve endurance, or enhance your overall fitness. Our commitment
          extends beyond just providing equipment; we offer exceptional customer
          service that includes personalized support and guidance from our team
          of professional trainers. Our professional coaches are not only highly
          qualified but also passionate about helping you achieve your fitness
          goals. They work closely with each member to create tailored training
          programs that address individual needs and preferences, ensuring that
          every session is productive and enjoyable. We believe that fitness
          should be an accessible and enjoyable journey, which is why we
          prioritize creating a welcoming atmosphere where everyone feels
          supported. Our modern facilities are equipped with the latest
          technology to track progress and enhance the workout experience,
          making it easier for you to see results and stay motivated. Visit us
          at 123 3/2 Street, Ninh Kieu, Can Tho, and immerse yourself in a
          fitness environment that combines top-tier equipment, expert coaching,
          and a supportive community. At GymMax, we are more than just a gym—we
          are your partner in achieving a healthier, stronger, and more
          confident you. Join us today and experience the best of fitness with a
          team that is dedicated to your success.
        </span>
      </p>
      <div>
